...
const baseMsgDepositToLiquidityPoolRequest: object = {
  poolId: Long.UZERO,
};
...
const baseMsgWithdrawFromLiquidityPoolRequest: object = {
  poolId: Long.UZERO,
};
...
const baseMsgSwapRequest: object = {
  poolId: Long.UZERO,
};
...
export interface Msg {
   ...
   */
  DepositToLiquidityPool(request: MsgDepositToLiquidityPool): Promise<MsgDepositToLiquidityPoolResponse>;

  /**
   *  Submit withdraw from to the liquidity pool batch.
   */
  WithdrawFromLiquidityPool(request: MsgWithdrawFromLiquidityPool): Promise<MsgWithdrawFromLiquidityPoolResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  CreateLiquidityPool(request: MsgCreateLiquidityPool): Promise<MsgCreateLiquidityPoolResponse> {
    ...
    const promise = this.rpc.request("tendermint.liquidity.Msg", "CreateLiquidityPool", data);
    return promise.then(data => MsgCreateLiquidityPoolResponse.decode(new Reader(data)));
  }

  DepositToLiquidityPool(request: MsgDepositToLiquidityPool): Promise<MsgDepositToLiquidityPoolResponse> {
    const data = MsgDepositToLiquidityPool.encode(request).finish();
    const promise = this.rpc.request("tendermint.liquidity.Msg", "DepositToLiquidityPool", data);
    return promise.then(data => MsgDepositToLiquidityPoolResponse.decode(new Reader(data)));
  }

  WithdrawFromLiquidityPool(request: MsgWithdrawFromLiquidityPool): Promise<MsgWithdrawFromLiquidityPoolResponse> {
    const data = MsgWithdrawFromLiquidityPool.encode(request).finish();
    const promise = this.rpc.request("tendermint.liquidity.Msg", "WithdrawFromLiquidityPool", data);
    return promise.then(data => MsgWithdrawFromLiquidityPoolResponse.decode(new Reader(data)));
  }
...
export const MsgCreateLiquidityPool = {
  encode(message: MsgCreateLiquidityPool, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Uint8Array | Reader, length?: number): MsgCreateLiquidityPool {
  ...
  fromPartial(object: DeepPartial<MsgCreateLiquidityPool>): MsgCreateLiquidityPool {
    const message = { ...baseMsgCreateLiquidityPool } as MsgCreateLiquidityPool;
    message.depositCoins = [];
    if (object.poolCreatorAddress !== undefined && object.poolCreatorAddress !== null) {
...
export const MsgCreateLiquidityPoolRequest = {
  encode(message: MsgCreateLiquidityPoolRequest, writer: Writer = Writer.create()): Writer {
    if (message.baseReq !== undefined && message.baseReq !== undefined) {
      BaseReq.encode(message.baseReq, writer.uint32(10).fork()).ldelim();
    }
    if (message.msg !== undefined && message.msg !== undefined) {
      MsgCreateLiquidityPool.encode(message.msg, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): MsgCreateLiquidityPoolRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgCreateLiquidityPoolRequest } as MsgCreateLiquidityPoolRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<MsgCreateLiquidityPoolRequest>): MsgCreateLiquidityPoolRequest {
    const message = { ...baseMsgCreateLiquidityPoolRequest } as MsgCreateLiquidityPoolRequest;
    if (object.baseReq !== undefined && object.baseReq !== null) {
  ...
  toJSON(message: MsgCreateLiquidityPoolRequest): unknown {
    const obj: any = {};
    message.baseReq !== undefined && (obj.baseReq = message.baseReq ? BaseReq.toJSON(message.baseReq) : undefined);
    message.msg !== undefined && (obj.msg = message.msg ? MsgCreateLiquidityPool.toJSON(message.msg) : undefined);
    return obj;
  },
};

export const MsgCreateLiquidityPoolResponse = {
  encode(message: MsgCreateLiquidityPoolResponse, writer: Writer = Writer.create()): Writer {
    if (message.stdTx !== undefined && message.stdTx !== undefined) {
      StdTx.encode(message.stdTx, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): MsgCreateLiquidityPoolResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgCreateLiquidityPoolResponse } as MsgCreateLiquidityPoolResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<MsgCreateLiquidityPoolResponse>): MsgCreateLiquidityPoolResponse {
    const message = { ...baseMsgCreateLiquidityPoolResponse } as MsgCreateLiquidityPoolResponse;
    if (object.stdTx !== undefined && object.stdTx !== null) {
  ...
  toJSON(message: MsgCreateLiquidityPoolResponse): unknown {
    const obj: any = {};
    message.stdTx !== undefined && (obj.stdTx = message.stdTx ? StdTx.toJSON(message.stdTx) : undefined);
    return obj;
  },
};

export const MsgDepositToLiquidityPool = {
  encode(message: MsgDepositToLiquidityPool, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Uint8Array | Reader, length?: number): MsgDepositToLiquidityPool {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgDepositToLiquidityPool } as MsgDepositToLiquidityPool;
    message.depositCoins = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(object: DeepPartial<MsgDepositToLiquidityPool>): MsgDepositToLiquidityPool {
    const message = { ...baseMsgDepositToLiquidityPool } as MsgDepositToLiquidityPool;
    message.depositCoins = [];
    if (object.depositorAddress !== undefined && object.depositorAddress !== null) {
...
export const MsgDepositToLiquidityPoolRequest = {
  encode(message: MsgDepositToLiquidityPoolRequest, writer: Writer = Writer.create()): Writer {
    if (message.baseReq !== undefined && message.baseReq !== undefined) {
      BaseReq.encode(message.baseReq, writer.uint32(10).fork()).ldelim();
    }
    writer.uint32(16).uint64(message.poolId);
    if (message.msg !== undefined && message.msg !== undefined) {
      MsgDepositToLiquidityPool.encode(message.msg, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): MsgDepositToLiquidityPoolRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgDepositToLiquidityPoolRequest } as MsgDepositToLiquidityPoolRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<MsgDepositToLiquidityPoolRequest>): MsgDepositToLiquidityPoolRequest {
    const message = { ...baseMsgDepositToLiquidityPoolRequest } as MsgDepositToLiquidityPoolRequest;
    if (object.baseReq !== undefined && object.baseReq !== null) {
      message.baseReq = BaseReq.fromPartial(object.baseReq);
    } else {
...
export const MsgDepositToLiquidityPoolResponse = {
  encode(message: MsgDepositToLiquidityPoolResponse, writer: Writer = Writer.create()): Writer {
    if (message.stdTx !== undefined && message.stdTx !== undefined) {
      StdTx.encode(message.stdTx, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): MsgDepositToLiquidityPoolResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgDepositToLiquidityPoolResponse } as MsgDepositToLiquidityPoolResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<MsgDepositToLiquidityPoolResponse>): MsgDepositToLiquidityPoolResponse {
    const message = { ...baseMsgDepositToLiquidityPoolResponse } as MsgDepositToLiquidityPoolResponse;
    if (object.stdTx !== undefined && object.stdTx !== null) {
      message.stdTx = StdTx.fromPartial(object.stdTx);
    } else {
...
export const MsgWithdrawFromLiquidityPool = {
  encode(message: MsgWithdrawFromLiquidityPool, writer: Writer = Writer.create()): Writer {
    writer.uint32(10).string(message.withdrawerAddress);
    writer.uint32(16).uint64(message.poolId);
    if (message.poolCoin !== undefined && message.poolCoin !== undefined) {
      Coin.encode(message.poolCoin, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): MsgWithdrawFromLiquidityPool {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgWithdrawFromLiquidityPool } as MsgWithdrawFromLiquidityPool;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<MsgWithdrawFromLiquidityPool>): MsgWithdrawFromLiquidityPool {
    const message = { ...baseMsgWithdrawFromLiquidityPool } as MsgWithdrawFromLiquidityPool;
    if (object.withdrawerAddress !== undefined && object.withdrawerAddress !== null) {
...
export const MsgWithdrawFromLiquidityPoolRequest = {
  encode(message: MsgWithdrawFromLiquidityPoolRequest, writer: Writer = Writer.create()): Writer {
    if (message.baseReq !== undefined && message.baseReq !== undefined) {
      BaseReq.encode(message.baseReq, writer.uint32(10).fork()).ldelim();
    }
    writer.uint32(16).uint64(message.poolId);
    if (message.msg !== undefined && message.msg !== undefined) {
      MsgWithdrawFromLiquidityPool.encode(message.msg, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): MsgWithdrawFromLiquidityPoolRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgWithdrawFromLiquidityPoolRequest } as MsgWithdrawFromLiquidityPoolRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<MsgWithdrawFromLiquidityPoolRequest>): MsgWithdrawFromLiquidityPoolRequest {
    const message = { ...baseMsgWithdrawFromLiquidityPoolRequest } as MsgWithdrawFromLiquidityPoolRequest;
    if (object.baseReq !== undefined && object.baseReq !== null) {
      message.baseReq = BaseReq.fromPartial(object.baseReq);
    } else {
...
export const MsgWithdrawFromLiquidityPoolResponse = {
  encode(message: MsgWithdrawFromLiquidityPoolResponse, writer: Writer = Writer.create()): Writer {
    if (message.stdTx !== undefined && message.stdTx !== undefined) {
      StdTx.encode(message.stdTx, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): MsgWithdrawFromLiquidityPoolResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgWithdrawFromLiquidityPoolResponse } as MsgWithdrawFromLiquidityPoolResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<MsgWithdrawFromLiquidityPoolResponse>): MsgWithdrawFromLiquidityPoolResponse {
    const message = { ...baseMsgWithdrawFromLiquidityPoolResponse } as MsgWithdrawFromLiquidityPoolResponse;
    if (object.stdTx !== undefined && object.stdTx !== null) {
      message.stdTx = StdTx.fromPartial(object.stdTx);
    } else {
...
export const MsgSwap = {
  encode(message: MsgSwap, writer: Writer = Writer.create()): Writer {
    ...
    if (message.offerCoin !== undefined && message.offerCoin !== undefined) {
      Coin.encode(message.offerCoin, writer.uint32(34).fork()).ldelim();
    }
    writer.uint32(42).string(message.demandCoinDenom);
    if (message.offerCoinFee !== undefined && message.offerCoinFee !== undefined) {
  ...
  toJSON(message: MsgSwap): unknown {
    ...
    message.orderPrice !== undefined && (obj.orderPrice = base64FromBytes(message.orderPrice !== undefined ? message.orderPrice : new Uint8Array()));
    return obj;
  },
};
...
export const MsgSwapRequest = {
  ...
  decode(input: Uint8Array | Reader, length?: number): MsgSwapRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BaseReq = {
  ...
  decode(input: Uint8Array | Reader, length?: number): BaseReq {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: BaseReq): unknown {
    ...
    if (message.gasPrices) {
      obj.gasPrices = message.gasPrices.map(e => e ? DecCoin.toJSON(e) : undefined);
    } else {
      obj.gasPrices = [];
    }
    message.gas !== undefined && (obj.gas = (message.gas || Long.UZERO).toString());
    message.gasAdjustment !== undefined && (obj.gasAdjustment = message.gasAdjustment);
...
export const StdTx = {
  ...
  decode(input: Uint8Array | Reader, length?: number): StdTx {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
