...
export const QueryLiquidityPoolResponse = {
	...
	decode(
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.liquidityPool = LiquidityPool.decode(
						reader,
						reader.uint32()
					);
					break;
	...
	fromJSON(object: any): QueryLiquidityPoolResponse {
		...
		if (
			object.liquidityPool !== undefined &&
			object.liquidityPool !== null
		) {
			message.liquidityPool = LiquidityPool.fromJSON(
	...
	fromPartial(
		...
		if (
			...
			message.liquidityPool = LiquidityPool.fromPartial(
				object.liquidityPool
			);
		} else {
			message.liquidityPool = undefined;
...
export const QueryLiquidityPoolBatchResponse = {
	...
	decode(
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.batch = LiquidityPoolBatch.decode(
						reader,
						reader.uint32()
					);
					break;
...
export const QueryLiquidityPoolsResponse = {
	encode(
		...
		for (const v of message.pools) {
			QueryLiquidityPoolResponse.encode(
				v!,
				writer.uint32(10).fork()
			).ldelim();
		}
	...
	decode(
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.pools.push(
						QueryLiquidityPoolResponse.decode(
							reader,
							reader.uint32()
						)
					);
...
export const QueryLiquidityPoolsBatchResponse = {
			...
			switch (tag >>> 3) {
				case 1:
					message.poolsBatch.push(
						QueryLiquidityPoolBatchResponse.decode(
							reader,
							reader.uint32()
						)
					);
	...
	fromJSON(object: any): QueryLiquidityPoolsBatchResponse {
		...
		if (object.poolsBatch !== undefined && object.poolsBatch !== null) {
			for (const e of object.poolsBatch) {
				message.poolsBatch.push(
					QueryLiquidityPoolBatchResponse.fromJSON(e)
				);
			}
		}
		if (object.pagination !== undefined && object.pagination !== null) {
	...
	fromPartial(
		...
		if (object.poolsBatch !== undefined && object.poolsBatch !== null) {
			for (const e of object.poolsBatch) {
				message.poolsBatch.push(
					QueryLiquidityPoolBatchResponse.fromPartial(e)
				);
			}
		}
		if (object.pagination !== undefined && object.pagination !== null) {
...
export const QueryPoolBatchSwapMsgResponse = {
	...
	decode(
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.swaps = BatchPoolSwapMsg.decode(
						reader,
						reader.uint32()
					);
					break;
...
export const QueryPoolBatchWithdrawMsgResponse = {
	...
	fromPartial(
		...
		if (object.withdraws !== undefined && object.withdraws !== null) {
			message.withdraws = BatchPoolWithdrawMsg.fromPartial(
				object.withdraws
			);
		} else {
			message.withdraws = undefined;
