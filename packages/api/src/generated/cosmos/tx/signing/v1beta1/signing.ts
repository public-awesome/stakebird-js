...
export const SignatureDescriptors = {
	...
	fromPartial(
		object: DeepPartial<SignatureDescriptors>
...
export const SignatureDescriptor_Data = {
	...
	fromJSON(object: any): SignatureDescriptor_Data {
		...
		if (object.single !== undefined && object.single !== null) {
			message.single = SignatureDescriptor_Data_Single.fromJSON(
				object.single
			);
		} else {
		...
		if (object.multi !== undefined && object.multi !== null) {
			message.multi = SignatureDescriptor_Data_Multi.fromJSON(
				object.multi
			);
		} else {
	...
	fromPartial(
		...
		if (object.multi !== undefined && object.multi !== null) {
			message.multi = SignatureDescriptor_Data_Multi.fromPartial(
				object.multi
			);
		} else {
			message.multi = undefined;
