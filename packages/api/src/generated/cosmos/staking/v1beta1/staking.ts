...
export const CommissionRates = {
	...
	fromJSON(object: any): CommissionRates {
		...
		if (
			object.maxChangeRate !== undefined &&
...
export const Validator = {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					...
					break;
				case 2:
					message.consensusPubkey = Any.decode(
						reader,
						reader.uint32()
					);
					break;
				...
				case 6:
					...
					break;
				case 7:
					message.description = Description.decode(
						reader,
						reader.uint32()
					);
					break;
				...
				case 9:
					...
					break;
				case 10:
					message.commission = Commission.decode(
						reader,
						reader.uint32()
					);
					break;
	...
	fromJSON(object: any): Validator {
		...
		if (
			object.unbondingTime !== undefined &&
			...
			switch (tag >>> 3) {
				case 1:
					message.triplets.push(
						DVVTriplet.decode(reader, reader.uint32())
					);
					break;
				default:
					reader.skipType(tag & 7);
...
export const UnbondingDelegation = {
	encode(
		...
		for (const v of message.entries) {
			UnbondingDelegationEntry.encode(
				v!,
...
export const UnbondingDelegationEntry = {
	...
	fromJSON(object: any): UnbondingDelegationEntry {
		...
		if (
			object.creationHeight !== undefined &&
			object.creationHeight !== null
		) {
		...
		if (
			object.completionTime !== undefined &&
		...
		if (
			object.initialBalance !== undefined &&
...
export const Params = {
	...
	decode(input: Reader | Uint8Array, length?: number): Params {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.unbondingTime = Duration.decode(
						reader,
						reader.uint32()
					);
					break;
	...
	fromJSON(object: any): Params {
		...
		if (
			object.maxValidators !== undefined &&
			object.maxValidators !== null
		) {
		...
		if (
			object.powerReduction !== undefined &&
			object.powerReduction !== null
		) {
...
export const DelegationResponse = {
	...
	decode(input: Reader | Uint8Array, length?: number): DelegationResponse {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.delegation = Delegation.decode(
						reader,
						reader.uint32()
					);
					break;
...
export const RedelegationResponse = {
	encode(
		...
		for (const v of message.entries) {
			RedelegationEntryResponse.encode(
				v!,
				writer.uint32(18).fork()
			).ldelim();
		}
	...
	decode(input: Reader | Uint8Array, length?: number): RedelegationResponse {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.redelegation = Redelegation.decode(
						reader,
						reader.uint32()
					);
					break;
	...
	fromPartial(
		object: DeepPartial<RedelegationResponse>
	): RedelegationResponse {
		const message = { ...baseRedelegationResponse } as RedelegationResponse;
		message.entries = [];
		if (object.redelegation !== undefined && object.redelegation !== null) {
			message.redelegation = Redelegation.fromPartial(
				object.redelegation
			);
		} else {
			message.redelegation = undefined;
