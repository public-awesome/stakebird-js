...
export const QueryValidatorRequest = {
	...
	fromJSON(object: any): QueryValidatorRequest {
		...
		if (
			object.validatorAddr !== undefined &&
			object.validatorAddr !== null
		) {
...
export const QueryDelegationRequest = {
	...
	fromJSON(object: any): QueryDelegationRequest {
		...
		if (
			object.delegatorAddr !== undefined &&
			object.delegatorAddr !== null
		) {
...
export const QueryUnbondingDelegationResponse = {
	...
	decode(
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.unbond = UnbondingDelegation.decode(
						reader,
						reader.uint32()
					);
					break;
...
export const QueryHistoricalInfoResponse = {
	...
	decode(
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.hist = HistoricalInfo.decode(
						reader,
						reader.uint32()
					);
					break;
...
export class QueryClientImpl implements Query {
	...
	Pool(request: QueryPoolRequest): Promise<QueryPoolResponse> {
		...
		return promise.then((data) =>
			QueryPoolResponse.decode(new Reader(data))
		);
	}
