...
export const AppDescriptor = {
	encode(message: AppDescriptor, writer: Writer = Writer.create()): Writer {
		if (message.authn !== undefined) {
			AuthnDescriptor.encode(
				message.authn,
				writer.uint32(10).fork()
			).ldelim();
		}
		if (message.chain !== undefined) {
			ChainDescriptor.encode(
				message.chain,
				writer.uint32(18).fork()
			).ldelim();
		}
		if (message.codec !== undefined) {
			CodecDescriptor.encode(
				message.codec,
	...
	decode(input: Reader | Uint8Array, length?: number): AppDescriptor {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.authn = AuthnDescriptor.decode(
						reader,
						reader.uint32()
					);
					break;
				case 2:
					message.chain = ChainDescriptor.decode(
						reader,
						reader.uint32()
					);
					break;
				case 3:
					message.codec = CodecDescriptor.decode(
						reader,
						reader.uint32()
					);
					break;
	...
	fromJSON(object: any): AppDescriptor {
		...
		if (
			object.queryServices !== undefined &&
			object.queryServices !== null
		) {
	...
	decode(input: Reader | Uint8Array, length?: number): TxDescriptor {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 2:
					message.msgs.push(
						MsgDescriptor.decode(reader, reader.uint32())
					);
					break;
				default:
					reader.skipType(tag & 7);
...
export const InterfaceAcceptingMessageDescriptor = {
	...
	toJSON(message: InterfaceAcceptingMessageDescriptor): unknown {
		...
		if (message.fieldDescriptorNames) {
			obj.fieldDescriptorNames = message.fieldDescriptorNames.map(
				(e) => e
			);
		} else {
...
export const ConfigurationDescriptor = {
	...
	toJSON(message: ConfigurationDescriptor): unknown {
		...
		message.bech32AccountAddressPrefix !== undefined &&
			(obj.bech32AccountAddressPrefix =
				message.bech32AccountAddressPrefix);
		return obj;
	},
};
...
export const MsgDescriptor = {
	...
	fromJSON(object: any): MsgDescriptor {
		...
		if (object.serviceMsg !== undefined && object.serviceMsg !== null) {
			message.serviceMsg = ServiceMsgDescriptor.fromJSON(
				object.serviceMsg
			);
		} else {
	...
	fromPartial(object: DeepPartial<MsgDescriptor>): MsgDescriptor {
		...
		if (object.serviceMsg !== undefined && object.serviceMsg !== null) {
			message.serviceMsg = ServiceMsgDescriptor.fromPartial(
				object.serviceMsg
			);
		} else {
			message.serviceMsg = undefined;
...
export const ServiceMsgDescriptor = {
	...
	fromJSON(object: any): ServiceMsgDescriptor {
		...
		if (
			object.requestTypeUrl !== undefined &&
			object.requestTypeUrl !== null
		) {
	...
	fromPartial(
		object: DeepPartial<ServiceMsgDescriptor>
...
export const GetQueryServicesDescriptorResponse = {
	...
	fromPartial(
		...
		if (object.queries !== undefined && object.queries !== null) {
			message.queries = QueryServicesDescriptor.fromPartial(
				object.queries
			);
		} else {
			message.queries = undefined;
...
export const GetTxDescriptorRequest = {
	...
	fromPartial(
		_: DeepPartial<GetTxDescriptorRequest>
	): GetTxDescriptorRequest {
		const message = {
			...baseGetTxDescriptorRequest,
		} as GetTxDescriptorRequest;
...
export const QueryMethodDescriptor = {
	...
	fromJSON(object: any): QueryMethodDescriptor {
		...
		if (
			object.fullQueryPath !== undefined &&
			object.fullQueryPath !== null
		) {
