...
export const ValidatorSigningInfo = {
	...
	fromJSON(object: any): ValidatorSigningInfo {
		...
		if (
			...
			message.missedBlocksCounter = Long.fromString(
				object.missedBlocksCounter
			);
		} else {
	...
	fromPartial(
		object: DeepPartial<ValidatorSigningInfo>
...
export const Params = {
	...
	fromJSON(object: any): Params {
		...
		if (
			...
			message.signedBlocksWindow = Long.fromString(
				object.signedBlocksWindow
			);
		} else {
		...
		if (
			...
			message.minSignedPerWindow = bytesFromBase64(
				object.minSignedPerWindow
			);
		}
		if (
