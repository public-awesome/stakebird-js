			...
			switch (tag >>> 3) {
				...
				case 3:
					message.contracts.push(
						Contract.decode(reader, reader.uint32())
					);
					break;
				case 4:
					message.sequences.push(
						Sequence.decode(reader, reader.uint32())
					);
					break;
				case 5:
	...
	toJSON(message: GenesisState): unknown {
		...
		message.params !== undefined &&
			(obj.params = message.params
				...
				: undefined);
		if (message.codes) {
			obj.codes = message.codes.map((e) =>
				e ? Code.toJSON(e) : undefined
			);
		} else {
			obj.codes = [];
		}
...
export const GenesisState_GenMsgs = {
	...
	decode(input: Reader | Uint8Array, length?: number): GenesisState_GenMsgs {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.storeCode = MsgStoreCode.decode(
						reader,
						reader.uint32()
					);
					break;
	...
	fromPartial(
		object: DeepPartial<GenesisState_GenMsgs>
...
export const Contract = {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					...
					break;
				case 2:
					message.contractInfo = ContractInfo.decode(
						reader,
						reader.uint32()
					);
					break;
				case 3:
					message.contractState.push(
						Model.decode(reader, reader.uint32())
					);
					break;
				default:
					reader.skipType(tag & 7);
	...
	fromJSON(object: any): Contract {
		...
		if (
			object.contractState !== undefined &&
	...
	fromPartial(object: DeepPartial<Contract>): Contract {
		...
		if (object.contractInfo !== undefined && object.contractInfo !== null) {
			message.contractInfo = ContractInfo.fromPartial(
				object.contractInfo
			);
		} else {
			message.contractInfo = undefined;
