...
const baseSwagger_ResponsesEntry: object = {
  key: "",
};

const baseSwagger_ExtensionsEntry: object = {
  key: "",
};
...
const baseOperation_ResponsesEntry: object = {
  key: "",
};

const baseOperation_ExtensionsEntry: object = {
  key: "",
};
...
const baseResponse_HeadersEntry: object = {
  key: "",
};

const baseResponse_ExamplesEntry: object = {
  key: "",
  value: "",
};

const baseResponse_ExtensionsEntry: object = {
  key: "",
};
...
const baseInfo_ExtensionsEntry: object = {
  key: "",
};
...
const baseExternalDocumentation: object = {
  description: "",
  url: "",
};
...
const baseSecurityDefinitions_SecurityEntry: object = {
  key: "",
};
...
const baseSecurityScheme_ExtensionsEntry: object = {
  key: "",
};
...
const baseSecurityRequirement_SecurityRequirementValue: object = {
  scope: "",
};

const baseSecurityRequirement_SecurityRequirementEntry: object = {
  key: "",
};
...
const baseScopes_ScopeEntry: object = {
  key: "",
  value: "",
};
...
export const Swagger = {
  encode(message: Swagger, writer: Writer = Writer.create()): Writer {
    ...
    if (message.securityDefinitions !== undefined && message.securityDefinitions !== undefined) {
    ...
    if (message.externalDocs !== undefined && message.externalDocs !== undefined) {
  ...
  decode(input: Uint8Array | Reader, length?: number): Swagger {
  ...
  toJSON(message: Swagger): unknown {
    ...
    message.securityDefinitions !== undefined && (obj.securityDefinitions = message.securityDefinitions ? SecurityDefinitions.toJSON(message.securityDefinitions) : undefined);
    if (message.security) {
...
export const Swagger_ResponsesEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Swagger_ResponsesEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Swagger_ExtensionsEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Swagger_ExtensionsEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Operation = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Operation {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Operation_ResponsesEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Operation_ResponsesEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Operation_ExtensionsEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Operation_ExtensionsEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Response = {
  encode(message: Response, writer: Writer = Writer.create()): Writer {
    writer.uint32(10).string(message.description);
    if (message.schema !== undefined && message.schema !== undefined) {
...
export const Response_HeadersEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Response_HeadersEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Response_ExamplesEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Response_ExamplesEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Response_ExtensionsEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Response_ExtensionsEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Info = {
  encode(message: Info, writer: Writer = Writer.create()): Writer {
    ...
    if (message.contact !== undefined && message.contact !== undefined) {
      Contact.encode(message.contact, writer.uint32(34).fork()).ldelim();
    }
    if (message.license !== undefined && message.license !== undefined) {
  ...
  decode(input: Uint8Array | Reader, length?: number): Info {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Info_ExtensionsEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Info_ExtensionsEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Contact = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Contact {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const License = {
  ...
  decode(input: Uint8Array | Reader, length?: number): License {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExternalDocumentation = {
  ...
  decode(input: Uint8Array | Reader, length?: number): ExternalDocumentation {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Schema = {
  encode(message: Schema, writer: Writer = Writer.create()): Writer {
    if (message.jsonSchema !== undefined && message.jsonSchema !== undefined) {
  ...
  decode(input: Uint8Array | Reader, length?: number): Schema {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const JSONSchema = {
  ...
  decode(input: Uint8Array | Reader, length?: number): JSONSchema {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Tag = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Tag {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SecurityDefinitions = {
  ...
  decode(input: Uint8Array | Reader, length?: number): SecurityDefinitions {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SecurityDefinitions_SecurityEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): SecurityDefinitions_SecurityEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SecurityScheme = {
  encode(message: SecurityScheme, writer: Writer = Writer.create()): Writer {
    ...
    if (message.scopes !== undefined && message.scopes !== undefined) {
  ...
  decode(input: Uint8Array | Reader, length?: number): SecurityScheme {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SecurityScheme_ExtensionsEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): SecurityScheme_ExtensionsEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SecurityRequirement = {
  ...
  decode(input: Uint8Array | Reader, length?: number): SecurityRequirement {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SecurityRequirement_SecurityRequirementValue = {
  ...
  decode(input: Uint8Array | Reader, length?: number): SecurityRequirement_SecurityRequirementValue {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SecurityRequirement_SecurityRequirementEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): SecurityRequirement_SecurityRequirementEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Scopes = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Scopes {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Scopes_ScopeEntry = {
  ...
  decode(input: Uint8Array | Reader, length?: number): Scopes_ScopeEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
