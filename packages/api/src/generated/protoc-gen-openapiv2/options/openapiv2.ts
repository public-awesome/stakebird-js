...
export const Info = {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 6:
					...
					break;
				case 7:
					const entry7 = Info_ExtensionsEntry.decode(
						reader,
						reader.uint32()
					);
	...
	fromJSON(object: any): Info {
		...
		if (
			object.termsOfService !== undefined &&
...
export const Info_ExtensionsEntry = {
	...
	fromPartial(
		object: DeepPartial<Info_ExtensionsEntry>
...
export const Schema = {
	...
	decode(input: Reader | Uint8Array, length?: number): Schema {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.jsonSchema = JSONSchema.decode(
						reader,
						reader.uint32()
					);
					break;
	...
	fromJSON(object: any): Schema {
		...
		if (
			object.discriminator !== undefined &&
...
export const JSONSchema = {
	...
	fromJSON(object: any): JSONSchema {
		...
		if (
			object.minProperties !== undefined &&
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					...
					break;
				case 2:
					message.value = SecurityScheme.decode(
						reader,
						reader.uint32()
					);
					break;
...
export const SecurityRequirement = {
	...
	fromJSON(object: any): SecurityRequirement {
		...
		if (
			...
			Object.entries(object.securityRequirement).forEach(
				([key, value]) => {
					message.securityRequirement[
						key
					] = SecurityRequirement_SecurityRequirementValue.fromJSON(
						value
					);
				}
			);
...
export const SecurityRequirement_SecurityRequirementEntry = {
	...
	toJSON(message: SecurityRequirement_SecurityRequirementEntry): unknown {
		...
		message.value !== undefined &&
			(obj.value = message.value
				? SecurityRequirement_SecurityRequirementValue.toJSON(
						message.value
				  )
				: undefined);
		return obj;
...
export const Scopes = {
	...
	decode(input: Reader | Uint8Array, length?: number): Scopes {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					const entry1 = Scopes_ScopeEntry.decode(
						reader,
						reader.uint32()
					);
					if (entry1.value !== undefined) {
