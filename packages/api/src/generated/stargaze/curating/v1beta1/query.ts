/* eslint-disable */
import { Params, Post, Upvote } from '../../../stargaze/curating/v1beta1/curating';
...
const baseQueryPostRequest: object = {
  vendorId: 0,
  postId: "",
};
...
const baseQueryUpvotesRequest: object = {
  vendorId: 0,
  postId: "",
};
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("stargaze.curating.v1beta1.Query", "Params", data);
    return promise.then(data => QueryParamsResponse.decode(new Reader(data)));
  }

  Posts(request: QueryPostsRequest): Promise<QueryPostsResponse> {
    const data = QueryPostsRequest.encode(request).finish();
    const promise = this.rpc.request("stargaze.curating.v1beta1.Query", "Posts", data);
    return promise.then(data => QueryPostsResponse.decode(new Reader(data)));
  }

  Post(request: QueryPostRequest): Promise<QueryPostResponse> {
    const data = QueryPostRequest.encode(request).finish();
    const promise = this.rpc.request("stargaze.curating.v1beta1.Query", "Post", data);
    return promise.then(data => QueryPostResponse.decode(new Reader(data)));
  }

  Upvotes(request: QueryUpvotesRequest): Promise<QueryUpvotesResponse> {
    const data = QueryUpvotesRequest.encode(request).finish();
    const promise = this.rpc.request("stargaze.curating.v1beta1.Query", "Upvotes", data);
    return promise.then(data => QueryUpvotesResponse.decode(new Reader(data)));
  }
...
export const QueryPostsRequest = {
  ...
  decode(input: Uint8Array | Reader, length?: number): QueryPostsRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPostRequest = {
  ...
  decode(input: Uint8Array | Reader, length?: number): QueryPostRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPostsResponse = {
  ...
  decode(input: Uint8Array | Reader, length?: number): QueryPostsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPostResponse = {
  encode(message: QueryPostResponse, writer: Writer = Writer.create()): Writer {
    if (message.post !== undefined && message.post !== undefined) {
      Post.encode(message.post, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): QueryPostResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryUpvotesRequest = {
  encode(message: QueryUpvotesRequest, writer: Writer = Writer.create()): Writer {
    writer.uint32(8).uint32(message.vendorId);
    writer.uint32(18).string(message.postId);
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): QueryUpvotesRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryUpvotesResponse = {
  encode(message: QueryUpvotesResponse, writer: Writer = Writer.create()): Writer {
    for (const v of message.upvotes) {
      Upvote.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): QueryUpvotesResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: DeepPartial<QueryUpvotesResponse>): QueryUpvotesResponse {
    const message = { ...baseQueryUpvotesResponse } as QueryUpvotesResponse;
    message.upvotes = [];
    if (object.upvotes !== undefined && object.upvotes !== null) {
      for (const e of object.upvotes) {
